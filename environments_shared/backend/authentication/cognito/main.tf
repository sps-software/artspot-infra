...
resource "aws_cognito_user_pool_client" "artspot-test-access" {
    allowed_oauth_flows                  = []
    allowed_oauth_flows_user_pool_client = false
    allowed_oauth_scopes                 = []
    callback_urls                        = []
    ...
    logout_urls                          = []
    name                                 = "artspot-web-test-client${local.environment_ext}"
    prevent_user_existence_errors        = "ENABLED"
    read_attributes                      = [
        "address",
        "birthdate",
...
resource "aws_ssm_parameter" "user_pool_admin_client_id" {
  name        = "/artspot/${var.environment}/cognito/user_pool_admin_client_id"
  description = "Cognito user pool client id for integration testing"
  type        = "String"
